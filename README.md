...
<p align="center">
  <img src="https://github.com/commit-check/commit-check/raw/main/docs/demo.gif" alt="commit-check demo">
</p>
...
- **Commit Check** uses a [default configuration](https://commit-check.github.io/commit-check/configuration.html) if you do not provide a `cchk.toml` or `commit-check.toml` file.
...
[commitlint](https://commitlint.js.org/) is a specialized commit-message linter.
...
*For* [GitHub Rulesets](https://docs.github.com/en/repositories/configuring-branches-and-merges-in-your-repository/managing-rulesets/about-rulesets),
push rulesets enforce metadata via regex patterns —
