...
from commit_check import DEFAULT_CONFIG, PASS, FAIL, author
...
class TestMain:
    @pytest.mark.parametrize(
        "argv, check_commit_call_count, check_branch_call_count, check_author_call_count, check_commit_signoff_call_count, check_merge_base_call_count",
        [
            ...
            (
                [CMD, "--branch", "--message", "--author-name", "--author-email"],
                1,
                1,
                2,
                0,
    ...
    def test_main(
        ...
        mocker.patch(
            ...
            return_value={"checks": [{"check": "dummy_check_type"}]},
        )
        ...
        m_check_commit_signoff = mocker.patch(
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                [CMD, "--message", "--author-name", "--author-email"],
                PASS,
                PASS,
                PASS,
                PASS,
